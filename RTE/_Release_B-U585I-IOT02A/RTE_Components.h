...
/* Keil::Device:STM32Cube HAL:ICACHE@1.3.0 */
#define RTE_DEVICE_HAL_ICACHE
/* Keil::Device:STM32Cube HAL:MDF@1.3.0 */
#define RTE_DEVICE_HAL_MDF
/* Keil::Device:STM32Cube HAL:OSPI@1.3.0 */
...
/* Keil::Device:STM32Cube LL:DLYB@1.3.0 */
#define RTE_DEVICE_LL_DLYB
/* Keil::Device:STM32Cube LL:GPIO@1.3.0 */
...
/* Keil::Device:STM32Cube LL:UCPD@1.3.0 */
